    ...
    <Layout className="contact-page">
      ...
      <div className="wrapper">
        ...
        <form className="contact-form" action="/thanks" name="contact" method="POST" data-netlify="true" data-netlify-honeypot="bot-field">
          ...
          <p>
            <label>Navn<input type="text" name="name" /></label>   
          </p>
          <p>
            <label>E-post<input type="email" name="email" /></label>
          </p>
          <p>
            <label>Emne<input type="text" name="subject" /></label>   
          </p>
          <p>
            <label>Melding<textarea name="message"></textarea></label>
          </p>
          <p className="text-align-right">
            <button className="button" type="submit">Send melding <span className="icon -right"><RiSendPlane2Line/></span></button>
          </p>
        </form>
      </div>
